...
do for [treatment_case in "nurt nonnurt"] {
		...
		do for [i=1:num_files-1] {
			plotstr = plotstr.sprintf("f%d(x) linestyle %d+1 title '', filename(%d*50) using 2:5 linestyle %d+1 title 'Gen %d'%s", i, i, i, i, i*50, (i == num_files-1) ? "" : ", ")
		}
