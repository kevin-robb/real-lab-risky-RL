...
do for [base_name in "nurt_Gen nonnurt_Gen"] {
	do for [i=0:50:5] { # should be 250
		input_file=base_name.i.'.dat'
		do for [j=0:9] { # should be 49
			...
			if (ARG1 eq "pdf") {
				set output base_name.i."Agent".j.".pdf"
			} else {
			...
			set title base_title.i."     Agent: ".j."     Learning Rate: ".learning_rate."     Fitness: ".fitness
